...
with_node \
  ...
  --target "/Users/ivoryhuo/Documents/HackWestern2024/Uplift/client/ios/Pods/Target Support Files/Pods-client/ExpoModulesProvider.swift" \
  --entitlement "/Users/ivoryhuo/Documents/HackWestern2024/Uplift/client/ios/client/client.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
